...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Basic FM Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic FM Rx")
        ...
        self.tuning = tuning = 91_300_000
        self.samp_rate = samp_rate = 8_000_000
        self.rf_decim = rf_decim = 40
        ...
        self._volume_range = qtgui.Range(0, 10.05, 0.05, 0.3, 200)
        self._volume_win = qtgui.RangeWidget(self._volume_range, self.set_volume, "Amplification", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._volume_win)
        # Create the options list
        self._tuning_options = [91300000, 107500000]
        # Create the labels list
        self._tuning_labels = ['WHQR', 'WAZO']
        ...
        self.osmosdr_source_0.set_center_freq((tuning + 1_400_000), 0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1_400_000, 1, 0, 0)
    ...
    def set_tuning(self, tuning):
        self.tuning = tuning
        self._tuning_callback(self.tuning)
        self.osmosdr_source_0.set_center_freq((self.tuning + 1_400_000), 0)
        self.qtgui_sink_x_0.set_frequency_range(self.tuning, 100_000)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 75_000, 25_000, window.WIN_HAMMING, 6.76))
